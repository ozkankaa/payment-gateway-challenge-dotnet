...
namespace PaymentGateway.Api.Infrastructure.Persistence.Migrations.PaymentEvent
{
    /// <inheritdoc />
    public partial class InitialPaymentEvent : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MerchantId = table.Column<Guid>(type: "TEXT", maxLength: 100, nullable: false),
                    ...
                    FraudDecision = table.Column<string>(type: "TEXT", nullable: true),
                    PspId = table.Column<string>(type: "TEXT", nullable: true),
                    PspTransactionId = table.Column<string>(type: "TEXT", nullable: true),
